...
export function safeUpdateField(
    ...
    // Note: value validation (validateFieldValue) is performed by the caller
    // (updateRecordField) before calling this function. We only do structural
    // checks here to avoid duplicate warnings.
